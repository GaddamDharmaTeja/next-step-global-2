...
import AdminCmsPagesPage from "./spa-pages/admin/cms-pages";
...
import AdminMediaPage from "./spa-pages/admin/media";
...
import CmsPublicPage from "./spa-pages/cms-page";
...
function AppRouter() {
  return (
    <Switch>
      ...
      <Route path="/services">
        {() => <CmsPublicPage slug="services" active="services" />}
      </Route>
      <Route path="/about">
        {() => <CmsPublicPage slug="about" active="about" />}
      </Route>
      ...
      <Route path="/portal">
        {() => <CmsPublicPage slug="portal" active="portal" />}
      </Route>
      ...
      <Route path="/admin/pages" component={AdminCmsPagesPage} />
      ...
      <Route path="/:slug">
        {(params) => <CmsPublicPage slug={params.slug} />}
      </Route>
